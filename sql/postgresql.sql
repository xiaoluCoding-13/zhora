...
;
ALTER TABLE "ai_llm_config" OWNER TO "zhora";
COMMENT ON COLUMN "ai_llm_config"."id" IS 'id';
COMMENT ON COLUMN "ai_llm_config"."name" IS '模型厂家';
COMMENT ON COLUMN "ai_llm_config"."code" IS '模型code';
COMMENT ON COLUMN "ai_llm_config"."model_name" IS '模型名称';
COMMENT ON COLUMN "ai_llm_config"."type" IS '模型类型';
COMMENT ON COLUMN "ai_llm_config"."api_key" IS '模型秘钥';
COMMENT ON COLUMN "ai_llm_config"."url" IS '模型base地址';
COMMENT ON COLUMN "ai_llm_config"."enable" IS '是否禁用';
COMMENT ON COLUMN "ai_llm_config"."priority" IS '优先级,数字越大优先级越高';
COMMENT ON COLUMN "ai_llm_config"."create_by" IS '创建人';
COMMENT ON COLUMN "ai_llm_config"."create_time" IS '创建时间';
COMMENT ON COLUMN "ai_llm_config"."update_by" IS '更新人';
COMMENT ON COLUMN "ai_llm_config"."update_time" IS '更新时间';
COMMENT ON COLUMN "ai_llm_config"."del_flag" IS '删除标记,true:已删除,false:正常';
COMMENT ON TABLE "ai_llm_config" IS '模型配置';

-- ----------------------------
-- Records of ai_llm_config
-- ----------------------------
BEGIN;
INSERT INTO "ai_llm_config" ("id", "name", "code", "model_name", "type", "api_key", "url", "enable", "priority", "create_by", "create_time", "update_by", "update_time", "del_flag") VALUES (1, 'DeepSeek', 'DEEP_SEEK', 'deepseek-chat', 'CHAT', '', 'https://api.deepseek.com', 'f', 0, NULL, NULL, NULL, NULL, 'f');
INSERT INTO "ai_llm_config" ("id", "name", "code", "model_name", "type", "api_key", "url", "enable", "priority", "create_by", "create_time", "update_by", "update_time", "del_flag") VALUES (2, 'Qwen', 'Q_WEN', 'qwen3-32b', 'CHAT', '', 'https://dashscope.aliyuncs.com/api/v1/services/aigc/text-generation/generation', 't', 1, NULL, NULL, NULL, NULL, 'f');
INSERT INTO "ai_llm_config" ("id", "name", "code", "model_name", "type", "api_key", "url", "enable", "priority", "create_by", "create_time", "update_by", "update_time", "del_flag") VALUES (3, 'Qwen_embedding', 'Q_WEN_EMBEDDING', 'text-embedding-v4', 'EMBEDDING', '', 'https://dashscope.aliyuncs.com/api/v1/services/aigc/text-generation/generation', 't', 2, NULL, NULL, NULL, NULL, 'f');
COMMIT;

-- ----------------------------
-- Primary Key structure for table ai_llm_config
-- ----------------------------
ALTER TABLE "ai_llm_config" ADD CONSTRAINT "ai_config_pkey" PRIMARY KEY ("id");

CREATE SCHEMA IF NOT EXISTS zhora;

DROP TABLE IF EXISTS "qwen_embedding_store";
CREATE TABLE "qwen_embedding_store" (
...
;
ALTER TABLE "qwen_embedding_store" OWNER TO "zhora";
COMMENT ON COLUMN "qwen_embedding_store"."create_by" IS '创建人';
COMMENT ON COLUMN "qwen_embedding_store"."create_time" IS '创建时间';
COMMENT ON COLUMN "qwen_embedding_store"."update_by" IS '更新人';
COMMENT ON COLUMN "qwen_embedding_store"."update_time" IS '更新时间';
COMMENT ON COLUMN "qwen_embedding_store"."del_flag" IS '删除标记,true:已删除,false:正常';

-- ----------------------------
-- Table structure for qwen_library_embedding_store
-- ----------------------------
DROP TABLE IF EXISTS "qwen_library_embedding_store";
CREATE TABLE "qwen_library_embedding_store" (
    "embedding_id" uuid NOT NULL,
    "embedding" "vector",
    "text" text COLLATE "pg_catalog"."default",
    "metadata" json,
...
;
ALTER TABLE "qwen_library_embedding_store" OWNER TO "zhora";
COMMENT ON COLUMN "qwen_library_embedding_store"."create_by" IS '创建人';
COMMENT ON COLUMN "qwen_library_embedding_store"."create_time" IS '创建时间';
COMMENT ON COLUMN "qwen_library_embedding_store"."update_by" IS '更新人';
COMMENT ON COLUMN "qwen_library_embedding_store"."update_time" IS '更新时间';
COMMENT ON COLUMN "qwen_library_embedding_store"."del_flag" IS '删除标记,true:已删除,false:正常';

-- ----------------------------
-- Primary Key structure for table qwen_embedding_store
-- ----------------------------
ALTER TABLE "qwen_embedding_store" ADD CONSTRAINT "qwen_embedding_store_pkey" PRIMARY KEY ("embedding_id");

-- ----------------------------
-- Primary Key structure for table qwen_library_embedding_store
-- ----------------------------
ALTER TABLE "qwen_library_embedding_store" ADD CONSTRAINT "qwen_library_embedding_store_pkey" PRIMARY KEY ("embedding_id");
