package com.zhora.admin.shiro.web.filter.kickout;
...
public class KickoutSessionFilter extends AccessControlFilter {
    ...
    private boolean isAjaxResponse(ServletRequest request, ServletResponse response) throws IOException {
        ...
        if (ServletUtils.isAjaxRequest(req)) {
            ServletUtils.renderString(res, objectMapper.writeValueAsString(
                    ResponseDTO.ofError(
                            AdminErrorCode.YOU_HAVE_LOGGED_IN_ELSEWHERE_PLEASE_CHANGE_YOUR_PASSWORD_OR_LOG_IN_AGAIN
                    )));
        } else {
