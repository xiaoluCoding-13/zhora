package com.zhora.admin.shiro.web.session;
...
public class OnlineWebSessionManager extends DefaultWebSessionManager {
    ...
    public OnlineSession getOnlineSession(SessionKey sessionKey) {
        ...
        if (Objects.nonNull(obj)) {
            ...
            BeanUtil.copyProperties(session, obj);
        }
        return session;
    }
    ...
    public void validateSessions() {
        ...
        ISysUserOnlineService userOnlineService = ApplicationContextUtil.getBean(ISysUserOnlineService.class);

        List<SysUserOnlineDTO> userOnlineList = userOnlineService.selectOnlineByExpired(expiredDate);
        // 批量过期删除
        List<String> needOfflineIdList = new ArrayList<String>();
        for (SysUserOnlineDTO userOnline : userOnlineList) {
            try {
