 ...
 *
 * @author zhehen.lu
 * @since 2025-08-28 17:26:15
 */
@Data
@EqualsAndHashCode(callSuper = true)
@Schema(name = "SysUserOnlineSearchDTO", description = "在线用户记录信息搜索模型")
public class SysUserOnlineSearchDTO extends PageBaseDTO {
    /**
     * 用户会话id
     */
     ...
     */
    @Schema(description = "在线状态on_line在线off_line离线")
